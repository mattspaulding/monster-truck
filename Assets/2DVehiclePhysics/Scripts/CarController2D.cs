...
{
	public bool AlwaysControl;
	//Set false to disable angular control when vehicle on the ground
	public float AngularVelocityForce = 80;
	public float AngularVelocityInput = 30;
	public bool DeadZone;
	//Set true if it neccessary to check when the car is flipped
...
public class CarController2D : MonoBehaviour
{
	...
	//Can vehicle automatically use brake when the player change moving direction?
	public float BackwardAccelerationFactor = 0.75f;
	public float BackwardMaxSpeedFactor = 0.5f;

	public bool AngularVelocityControl;
	//Can player rotate the vehicle?
	...
	//Is the vehicle body touches the ground?
	...
	public class Wheel
	{
		...
		public bool IsGrounded;
		//Is this wheel touches the ground?
